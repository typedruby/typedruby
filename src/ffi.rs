...
pub struct Builder {
    ...
    pub tr_any: unsafe extern "C" fn(special: *const Token) -> *mut Node,
    ...
    pub tr_class: unsafe extern "C" fn(special: *const Token) -> *mut Node,
    ...
    pub tr_geninst: unsafe extern "C" fn(cpath: *mut Node, begin: *const Token, genargs: *mut NodeList, end: *const Token) -> *mut Node,
    ...
    pub tr_instance: unsafe extern "C" fn(special: *const Token) -> *mut Node,
    ...
    pub tr_self: unsafe extern "C" fn(special: *const Token) -> *mut Node,
