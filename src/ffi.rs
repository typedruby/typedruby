...
pub struct Builder {
    ...
    pub keyword_cmd: unsafe extern "C" fn(type_: c_int, keyword: *const Token, lparen: *const Token, args: *mut NodeList, rparen: *const Token) -> *mut Node,
    ...
    pub logical_op: unsafe extern "C" fn(type_: c_int, lhs: *mut Node, op: *const Token, rhs: *mut Node) -> *mut Node,
