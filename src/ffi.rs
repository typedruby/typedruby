...
pub struct Builder {
    ...
    pub keyword_redo: unsafe extern "C" fn(keyword: *const Token, lparen: *const Token, args: *mut NodeList, rparen: *const Token) -> *mut Node,
    pub keyword_retry: unsafe extern "C" fn(keyword: *const Token, lparen: *const Token, args: *mut NodeList, rparen: *const Token) -> *mut Node,
    ...
    pub keyword_zsuper: unsafe extern "C" fn(keyword: *const Token, lparen: *const Token, args: *mut NodeList, rparen: *const Token) -> *mut Node,
    ...
    pub loop_: unsafe extern "C" fn(type_: c_int, keyword: *const Token, cond: *mut Node, do_: *const Token, body: *mut Node, end: *const Token) -> *mut Node,
    ...
    pub postexe: unsafe extern "C" fn(body: *mut Node) -> *mut Node,
    pub preexe: unsafe extern "C" fn(node: *mut Node) -> *mut Node,
