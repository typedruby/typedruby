...
pub enum Node {
    ...
    Prototype       (Loc,   Option<Box<Node>>, Box<Node>, Option<Box<Node>>),
    Redo            (Loc),
    ...
    True            (Loc),
    TyAny           (Loc),
    TyArray         (Loc,   Box<Node>),
    TyCast          (Loc,   Box<Node>, Box<Node>),
    TyClass         (Loc),
    TyCpath         (Loc,   Box<Node>),
    TyGenargs       (Loc,   Vec<Box<Node>>),
    TyGendecl       (Loc,   Box<Node>, Vec<Box<Node>>),
    TyGendeclarg    (Loc,   String),
    TyGeninst       (Loc,   Box<Node>, Vec<Box<Node>>),
    TyHash          (Loc,   Box<Node>, Box<Node>),
    TyInstance      (Loc),
    TyIvardecl      (Loc,   Id, Box<Node>),
    TyNil           (Loc),
    TyNillable      (Loc,   Box<Node>),
    TyOr            (Loc,   Box<Node>, Box<Node>),
    TypedArg        (Loc,   Box<Node>, Box<Node>),
    TyProc          (Loc,   Box<Node>),
    TySelf          (Loc),
    TyTuple         (Loc,   Vec<Box<Node>>),
