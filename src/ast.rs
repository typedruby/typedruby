...
pub enum Node {
    ...
    Casgn           (Loc,   Option<Rc<Node>>, Id, Option<Rc<Node>>),
    Cbase           (Loc),
...
impl Node {
    pub fn loc(&self) -> &Loc {
        match self {
            ...
            &Node::TyGendeclarg(ref loc, _) => loc,
