...
struct BuilderInterface {
	...
	pub multi_lhs1: unsafe extern "C" fn(builder: *mut Builder, begin: *const TokenPtr, item: *mut Rc<Node>, end: *const TokenPtr) -> *mut Rc<Node>,
...
unsafe extern "C" fn multi_lhs1(builder: *mut Builder, begin: *const TokenPtr, item: *mut Rc<Node>, end: *const TokenPtr) -> *mut Rc<Node> {
	let begin = token_from_c(begin);
	let item = node_from_c(item);
	let end = token_from_c(end);
	(*builder).multi_lhs1(begin, item, end).to_raw()
}
